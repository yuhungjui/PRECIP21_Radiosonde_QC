...
for di = 1:length(data_L4_list)
    ...
    eval([' data_L4 = load_data.RS_L4u_',data_L4_list(di).name(10:end-4),'; ']);
    ...
    fprintf(output_fileID, ['sondeid,"',data_L4.SondeID,'"\n']);
    fprintf(output_fileID, 'sondetype,"Vaisala RS41-SGP"\n');
    fprintf(output_fileID, 'launchsite,"Christman Field"\n\n');
    
    % Data header:
    fprintf(output_fileID, 'Fields,    Time,   Pressure,  Temperature,     RH,     Speed, Direction,     Latitude,     Longitude,   Altitude,     Gpsalt,   Ascent \n');
    fprintf(output_fileID, 'Units,      sec,         mb,     deg C,         %%,       m/s,       deg,          deg,           deg,          m,          m,      m/s \n');
    
    % Write data:
    fprintf(output_fileID,'Data,    %6.1f,    %7.2f,    %6.2f,    %6.2f,    %6.2f,    %6.2f,    %9.5f,    %9.5f,    %7.1f,    %7.1f,    %5.1f \n', ...
            [data_L4.TIME_s ...
            ,data_L4.P ...
            ,data_L4.TC ...
            ,data_L4.RH ...
